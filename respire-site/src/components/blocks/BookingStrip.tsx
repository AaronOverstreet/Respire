...
export function BookingStrip() {
  return (
    <div className="booking-strip surface-card" id="book">
      ...
      <p>
        Offering in-person sessions in the Portland, Oregon area and{" "}
        <strong>Zoom sessions worldwide</strong>. For a free 15 minute meet and
        greet, appointments, and questions, book online or reach out via the
        contact page.
      </p>
